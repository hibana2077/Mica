...
# Linear probe 10% labels (Dataset-1 -> Dataset-2)
python3 src/linear_probe.py \
  ...
  --output_dir output/LP_resnet50_D1toD2_f10 \
  --label_fraction 0.10 --epochs 100 --batch_size 128 --lr 0.001 --no_amp >> S004.log 2>&1
