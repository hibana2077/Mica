...
# Linear probe 100% labels (Dataset-1 -> Dataset-2)
python3 src/linear_probe.py \
  ...
  --output_dir output/LP_resnet50_D1toD2_f100 \
  --label_fraction 1.0 --epochs 100 --batch_size 128 --lr 0.001 --no_amp >> S005.log 2>&1
